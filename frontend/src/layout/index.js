        ...
        <DialogContent>
          <Box className={classes.aboutContent}>
            <Box className={classes.aboutItem}>
              ...
              <Typography>Desenvolvedor: Eurico Junior</Typography>
            </Box>
            <Box className={classes.aboutItem}>
              ...
              <Typography>
                Email:{" "}
                <Link
                  href="mailto:euricotecnologia@gmail.com"
                  className={classes.aboutLink}
                >
                  euricotecnologia@gmail.com
                </Link>
              </Typography>
            </Box>
            <Box className={classes.aboutItem}>
              ...
              <Typography>
                WhatsApp:{" "}
                <Link
                  href="https://wa.me/5519971395449"
                  target="_blank"
                  rel="noopener"
                  className={classes.aboutLink}
                >
            ...
            <Box className={classes.aboutItem}>
              ...
              <Typography>Versão: 6.1.9</Typography>
            </Box>
            <Box className={classes.aboutItem}>
              <FacebookIcon className={classes.aboutIcon} />
              <Typography>
                Facebook:{" "}
                <Link
            ...
            <Box className={classes.aboutItem}>
              <YouTubeIcon className={classes.aboutIcon} />
              <Typography>
                YouTube:{" "}
                <Link
