...
app.use(
  "/chat-media",
  express.static(path.resolve(__dirname, "..", "public", "chat-media"))
);

const swaggerFilePath = path.resolve(__dirname, "..", "public", "docs", "swagger.json");
if (fs.existsSync(swaggerFilePath)) {
  ...
  if (
    ...
    swaggerDocument.servers[0].variables.baseUrl.default =
      process.env.BACKEND_URL;
  }
  ...
  app.use(
    ...
    swaggerUi.setup(swaggerDocument, {
      ...
      customSiteTitle: "API Kmenu - Documentação"
    })
  );
}
